...
public class HostcachedimageManager extends ComputeJointManager {
	...
	public HostcachedimageManager(
			EndpointType endpointType, HostManager master, CachedimageManager slave) {
		super(
				"hostcachedimage",
				"hostcachedimages",
				endpointType,
				new String[]{
						"Host_ID", "Host", "Cachedimage_ID", "Image", "Size", "Status", "Path", "Reference"
				},
				new String[]{},
				master,
				slave);
