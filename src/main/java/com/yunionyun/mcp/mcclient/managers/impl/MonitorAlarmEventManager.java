...
public class MonitorAlarmEventManager extends BaseMonitorManager {
	...
	public MonitorAlarmEventManager(EndpointType endpointType) {
		super(
				"alarm_event",
				"alarm_events",
				endpointType,
	...
	public void batchSubmit(Session s, List<JSONObject> list)
	...
	public void batchUpdate(Session s, List<JSONObject> list)
			throws McClientJavaBizException, IOException, JSONClientException {
		JSONObject params = buildBatchParam(list);
