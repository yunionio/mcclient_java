...
public class ContactGroupManager extends BaseNotifyManager {
    ...
    public ContactGroupManager(EndpointType endpointType){
        super("contact-group", "contact-groups",endpointType,
                new String[]{"id", "name", "domain_id", "domain_name", "members", "status", "create_by", "update_by", "delete_by", "gmt_create", "gmt_modified", "gmt_delete", "project_id", "remark"},
                new String[]{});
    }
}
