...
public class DevToolCronjobManager extends BaseDevtoolManager {
    ...
    public DevToolCronjobManager(EndpointType endpointType){
        super("devtool_cronjob", "devtool_cronjobs",endpointType,
                new String[]{"id", "ansible_playbook_id", "template_id", "server_id", "name", "day", "hour", "min", "sec", "interval", "start", "enabled", "created_at"},
                new String[]{});
    }
}
