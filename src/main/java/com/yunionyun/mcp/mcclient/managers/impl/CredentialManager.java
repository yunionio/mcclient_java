...
public class CredentialManager extends KeystoneManager {
    ...
    public CredentialManager(EndpointType endpointType) {
        super("credential", "credentials", endpointType,
                new String[]{},
                new String[]{"ID", "Type", "user_id", "project_id", "blob"});
    }

    private ListResult fetchCredentials(Session session,String secType,String uid,String pid) throws JSONClientException, McClientJavaBizException, IOException {
    ...
    public ListResult fetchAccessKeySecrets(Session session,String uid,String pid) throws JSONClientException, McClientJavaBizException, IOException {
        return fetchCredentials(session,ACCESS_SECRET_TYPE,uid,pid);
    }

    public ListResult fetchTotpSecrets(Session session,String uid) throws JSONClientException, McClientJavaBizException, IOException {
        return fetchCredentials(session,TOTP_TYPE,uid,"");
    }

    public ListResult fetchRecoverySecrets(Session session,String uid) throws JSONClientException, McClientJavaBizException, IOException {
