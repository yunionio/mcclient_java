...
public class BaremetalnetworkManager extends ComputeJointManager {
    ...
    public  BaremetalnetworkManager(EndpointType endpointType,HostManager master, NetworkManager slave){
        super("baremetalnetwork", "baremetalnetworks",endpointType,
                new String[]{"Baremetal_ID", "Host", "Network_ID", "Network", "IP_addr", "Mac_addr", "Nic_Type"},
