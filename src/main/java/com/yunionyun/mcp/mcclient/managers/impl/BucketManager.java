...
public class BucketManager extends ComputeManager {
    ...
    public BucketManager(EndpointType endpointType){
        super("bucket", "buckets",endpointType,
                new String[]{"ID", "Name", "Storage_Class", "Status", "location", "acl", "region", "manager_id"},
                new String[]{});
    }

    public JSONObject upLoad(Session session, String bucketId, String key, InputStream body, long contLength,
                             String storageClass, String acl, HttpHeaders headers) throws JSONClientException, IOException, NoSuchAlgorithmException, McClientJavaBizException, KeyManagementException {
