...
public class SchedulerManager extends BaseSchedulerManager {
    ...
    public ScheduleOutput doSchedule(Session session, ScheduleInput input, int count) throws JSONClientException, McClientJavaBizException, IOException {
    ...
    public JSONObject doForecast(Session session, JSONObject params) throws JSONClientException, McClientJavaBizException, IOException {
