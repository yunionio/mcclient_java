...
public class CloudregionManager extends ComputeManager {
    ...
    public JSONArray getRegionCities(Session session, JSONObject params) throws JSONClientException, McClientJavaBizException, IOException {
        return getRegionAttributeList(session,params,"city");
    }

    public JSONArray getRegionProviders(Session session, JSONObject params) throws JSONClientException, McClientJavaBizException, IOException {
        return getRegionAttributeList(session, params,"provider");
    }

    private  JSONArray getRegionAttributeList(Session session, JSONObject params ,String attr) throws JSONClientException, McClientJavaBizException, IOException {
