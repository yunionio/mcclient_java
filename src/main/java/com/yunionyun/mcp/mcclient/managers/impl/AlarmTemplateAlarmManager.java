...
import com.yunionyun.mcp.mcclient.managers.JointResourceManager;
...
public class AlarmTemplateAlarmManager extends MonitorJointManager {
    ...
    public AlarmTemplateAlarmManager(EndpointType endpointType, AlarmTemplateManager master, AlarmManager slave) {
        super("alarmtemplate_alarm", "alarmtemplate_alarms",endpointType,
                new String[]{"id", "alarm_template_name", "alarm_template_desc", "belongto", "status", "create_by", "update_by", "delete_by", "gmt_create", "gmt_modified", "gmt_delete", "is_deleted", "project_id", "remark"},
