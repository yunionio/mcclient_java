...
import com.yunionyun.mcp.mcclient.managers.impl.compute.StorageManager;
...
public class BaremetalstorageManager extends ComputeJointManager {
	...
	public BaremetalstorageManager(
			EndpointType endpointType, HostManager master, StorageManager slave) {
		super(
				"baremetalstorage",
				"baremetalstorages",
				endpointType,
				new String[]{
						"Baremetal_ID", "Baremetal", "Storage_ID", "Storage", "Config", "Real_capacity"
				},
				new String[]{},
				master,
				slave);
