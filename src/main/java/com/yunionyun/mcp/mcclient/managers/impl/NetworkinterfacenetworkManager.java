...
public class NetworkinterfacenetworkManager extends ComputeJointManager {
    ...
    public NetworkinterfacenetworkManager(EndpointType endpointType, NetworkinterfaceManager master, NetworkManager slave) {
        super("networkinterfacenetwork", "networkinterfacenetworks", endpointType,
                new String[]{"Networkinterface_ID", "Networkinterface", "Network_ID", "Network", "IP_Addr", "Primary"},
