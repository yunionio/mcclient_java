...
public class HttpClientUtils {
	...
	public static String postJsonParameters(
			String url, String parameterStr, Map<String, String> headers) {
	...
	public static void main(String[] args) {
		...
		//            String str=
		// post("https://localhost:443/ssl/test.shtml","name=12&page=34","application/x-www-form-urlencoded", "UTF-8", 10000, 10000);
