...
public class ServicesV3ManagerTest extends TestCase {
	...
	public void testApp() {
		...
		try {
			...
			if (rtn != null) {
				if (rtn == null || rtn.getJSONObject("config") == null || rtn.getJSONObject("config").getJSONObject("default") == null) {
					System.out.println("false");
				}
				if (rtn.getJSONObject("config").getJSONObject("default").getBoolean("non_default_domain_projects") == null) {
					System.out.println("false");
				}
				System.out.println(rtn.getJSONObject("config").getJSONObject("default").getBoolean("non_default_domain_projects"));
			}
